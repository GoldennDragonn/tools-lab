...
# Create a new user 'ubadmin' with default home directory
sudo useradd -m ubadmin

# Set password for the new user
echo -e "Aa123456\nAa123456" | sudo passwd ubadmin

# Add 'ubadmin' user to the 'sudo' group
sudo usermod -aG sudo ubadmin
