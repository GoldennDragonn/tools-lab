...
sudo apt-get update
sudo apt-get install -y docker-ce=5:19.03.15~3-0~ubuntu-focal docker-ce-cli=5:19.03.15~3-0~ubuntu-focal containerd.io docker-compose-plugin
...
# sed -i '/- 192.168.56.101\/24/a \      gateway4: 192.168.56.254' /etc/netplan/50-vagrant.yaml
# sed -i '/- 192.168.56.102\/24/a \      gateway4: 192.168.56.254' /etc/netplan/50-vagrant.yaml
# sed -i '/- 192.168.56.103\/24/a \      gateway4: 192.168.56.254' /etc/netplan/50-vagrant.yaml
